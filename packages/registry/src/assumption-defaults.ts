...
export const DEFAULT_ASSUMPTIONS: Array<{
  ...
  { key: "risk_drawdown_reaction", value: 2, unit: "SCORE", description: "Questionnaire: reaction to a 30% portfolio drop (1=sell, 2=hold, 3=buy more)" },
  { key: "risk_investment_experience", value: 2, unit: "SCORE", description: "Questionnaire: experience with market investments (1=none, 2=some, 3=experienced)" },
  { key: "risk_spending_flexibility", value: 2, unit: "SCORE", description: "Questionnaire: ability to cut expenses in a bad stretch (1=rigid, 2=some, 3=flexible)" },
